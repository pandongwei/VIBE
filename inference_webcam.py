...
class MPT():
    ...
    def run_tracker(self, frame):
        ...
        trackers = []
        frame = frame.to(self.device)  # shape: torch.Size([1, 3, 1080, 1920])
...
def main(args):
    ...
    out = cv2.VideoWriter('output/test_1people.avi', fourcc, 30.0, (1920, 1080), True)

    # load renderer
    renderer = Renderer(resolution=(1920, 1080), orig_img=True, wireframe=args.wireframe)
